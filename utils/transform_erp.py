...
from .transform import normalize_ea


def erp_erp2vu(*, nm: np.ndarray, proj_shape=None) -> np.ndarray:
...
def erp_vu2ea(*, vu: np.ndarray) -> np.ndarray:
    shape = [2]
...
def erp_vu2erp(*, vu, proj_shape=None) -> np.ndarray:
    if proj_shape is None:
...
def erp_ea2erp(*, ea: np.ndarray, proj_shape=None) -> np.ndarray:
    """
...
def erp_erp2ea(*, nm: np.ndarray, proj_shape=None) -> np.ndarray:
