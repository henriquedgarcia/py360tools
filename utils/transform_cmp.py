...
from .transform import ea2xyz, xyz2ea


def cmp_cmp2nmface(*, nm, proj_shape=None) -> np.ndarray:
    """
...
def cmp_nmface2vuface(*, nmface: np.ndarray, proj_shape=None) -> np.ndarray:
    """
...
def cmp_vuface2xyz_face(*, vuface: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
...
def cmp_xyz2vuface(*, xyz: np.ndarray) -> np.ndarray:
    """
...
def cmp_vuface2nmface(*, vuface, proj_shape=None) -> np.ndarray:
    """
...
def cmp_nmface2cmp_face(*, nmface, proj_shape=None) -> tuple[np.ndarray, np.ndarray]:
    """
...
def cmp_xyz2cmp_face(*, xyz: np.ndarray, proj_shape=None) -> tuple[np.ndarray, np.ndarray]:
    """
    ...
    nm, face = cmp_nmface2cmp_face(nmface=nmface, proj_shape=proj_shape)
    return nm, face


def cmp_cmp2xyz_face(*, nm: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
    """
...
def cmp_ea2cmp_face(*, ea: np.ndarray, proj_shape: tuple = None) -> tuple[np.ndarray, np.ndarray]:
    """
    ...
    xyz = ea2xyz(ea=ea)
    nm, face = cmp_xyz2cmp_face(xyz=xyz, proj_shape=proj_shape)
    return nm, face


def cmp_cmp2ea_face(*, nm: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
